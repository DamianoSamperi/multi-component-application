    ...
    for step in steps:
        ...
        container = {
            ...
            "readinessProbe": {
                ...
                "initialDelaySeconds": 30,  # aspetta 30s prima della prima verifica
                "periodSeconds": 8,          # riprova ogni 8s
        ...
        if gpu_count > 0:
            container["resources"] = {"requests": {"memory": "512Mi","nvidia.com/gpu.shared": gpu_count},"limits": {"nvidia.com/gpu.shared":  gpu_count ,  "memory": "2.5Gi"}}
        else:
